...
@interface MessageFinishController ()
...
@implementation MessageFinishController
...
- (void)starButtonAction:(UIButton *)sender {
    ...
    if (self.messageFinishBloack) {
        self.messageFinishBloack(sender);
    }
}
